...
INSERT INTO `system_article` (`article_id`, `title`, `content`, `category_id`, `author_id`, `created_at`) VALUES (1,'北京的顶级火锅店','北京是一座美食之都，各种美食琳琅满目。而火锅作为冬季最受欢迎的美食之一，更是不可错过。今天，我们就来推荐几家北京的顶级火锅店。\n\n1. 海底捞火锅\n海底捞以其优质的服务和美味的火锅闻名，店内的番茄锅底和麻辣锅底特别受欢迎。店员的贴心服务让你在等待时不会觉得无聊，各种小吃和小游戏应有尽有。\n\n2. 大渔铁板。顶级的和牛和海鲜让你一饱口福。店内环境雅致，非常适合家庭聚餐和朋友聚会。\n\n3. 小龙坎老火锅\n作为重庆火锅的代表，小龙坎在北京也有多家分店。其独特的麻辣锅底让你尽享地道的重庆风味。喜欢重口味的朋友一定不能错过。',1,32,'2024-07-11 23:08:53'),(2,'苏州园林一日游','苏州以其秀丽的园林和古老的水乡闻名于世。今天我们就来推荐一条苏州园林一日游的路线。\n\n1. 拙政园\n拙政园是苏州最大的古典园林，也是中国四大名园之一。园内布局精美，亭台楼阁错落有致，步移景异，美不胜收。\n\n2. 狮子林\n狮子林以其独特的假山石景观闻名，园内的假山形态各异，宛如一座石林。爬上假山，可以俯瞰整个园林的美景。\n\n3. 网师园\n网师园虽然面积不大，但布局精巧，以小见大。园内的建筑和水景相互映衬，形成了一幅天然的山水画。',2,33,'2024-07-10 23:08:53'),(3,'上海的顶级购物中心','上海是购物天堂，各大购物中心汇聚了国内外顶级品牌。今天我们就来介绍几家上海的顶级购物中心。\n\n1. 恒隆广场\n恒隆广场位于南京西路，是上海最奢华的购物中心之一。这里汇聚了众多国际顶级品牌，如LV、Gucci、Chanel等，是时尚爱好者的天堂。\n\n2. 国金中心商场（IFC Mall）\n国金中心商场位于陆家嘴金融区，拥有众多高端品牌和精品店。这里不仅是购物的好地方，还有许多高档餐厅和咖啡馆，是放松和购物的绝佳去处。\n\n3. 静安嘉里中心\n静安嘉里中心位于静安寺商业区，集购物、餐饮、娱乐于一体。这里的品牌丰富多样，从高端奢侈品到潮流时尚应有尽有，是年轻人购物的首选。',3,34,'2024-07-09 23:08:53'),(4,'广州的夜生活','广州的夜生活丰富多彩，各种酒吧、夜店和夜市让人流连忘返。今天我们就来推荐几处广州夜生活的好去处。\n\n1. 珠江夜游\n珠江夜游是体验广州夜景的最佳方式。乘坐游船，欣赏两岸的璀璨灯光和美丽的夜景，是一次难忘的体验。\n\n2. 太古汇\n太古汇是广州最时尚的购物中心之一，夜晚的太古汇灯光璀璨，各种高档餐厅和酒吧让你享受一个愉快的夜晚。\n\n3. 上下九步行街\n上下九步行街是广州著名的购物和美食街。夜晚的步行街热闹非凡，各种小吃摊位和特色店铺让你尽情享受广州的夜生活。',4,35,'2024-07-08 23:08:53'),(5,'管理平台通知','新增文章发布功能',5,1,'2024-07-08 23:08:53');
...
INSERT INTO `system_article_category` VALUES (1,'美食'),(2,'旅游'),(3,'购物'),(4,'娱乐'),(5,'通知');
...
-- Dump completed on 2024-07-16 13:22:28
